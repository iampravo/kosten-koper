...
- **Own vs. rent, at any horizon** — a single box driven by a year/month slider (1 month to 30 years) instead of fixed checkpoints. Shows upfront cost, monthly cost (EMI + HOA + insurance), and — cumulative to the slider's point — tax rebate, interest paid, and principal paid, each with its share of total payments. The headline is deliberately simple: principal paid + home value growth ("money you kept") vs. cumulative rent ("money that's gone"), so it's a direct answer to "how much have I actually built vs. thrown away on rent."
